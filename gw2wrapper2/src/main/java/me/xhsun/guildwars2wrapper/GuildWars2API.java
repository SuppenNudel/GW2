...
interface GuildWars2API {
	...
	@GET("/v2/characters/{name}/quests")
	Call<List<Integer>> getCharacterQuests(@Path("name") String name, @Query("access_token") String token);
	...
	//Quests
	@GET("/v2/quests")
	Call<List<Integer>> getAllQuestIds();
	
	@GET("/v2/quests")
	Call<List<Quest>> getQuestInfo(@Query("lang") String lang, @Query("page") String page, @Query("page_size") String pageSize, @Query("id") Integer id, @Query("id") String ids);

	@GET("/v2/quests/{id}")
	Call<Quest> getQuestInfo(@Path("id") Integer id, @Query("lang") String lang, @Query("page") String page, @Query("page_size") String pageSize);
